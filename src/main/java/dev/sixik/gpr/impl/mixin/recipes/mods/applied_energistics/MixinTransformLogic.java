...
public class MixinTransformLogic {
    ...
    public static boolean tryTransform(ItemEntity entity, Predicate<TransformCircumstance> circumstancePredicate) {
        ...
        if(RecipeStageUtils.hasRestriction(TransformRecipe.TYPE)) {
            final Player player = RecipeStageUtils.getNearestPlayer(entity.level(), pos);
            if(player == null) return false;
            recipeHolders = RecipeStageUtils.filterRecipes(recipeHolders, player);
        }
